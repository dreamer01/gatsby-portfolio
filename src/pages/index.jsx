			...
			<Content speed={0.4} offset={1.2} factor={2}>
				<Inner>
					...
					<ProjectsWrapper>
						...
						>
							As I joined gym first time, I felt a need for an app where I can
							have record for my weekly excercises and diet. So I built one.
						</ProjectCard>
						<ProjectCard
						...
						>
							I built this one to practise my skills and share my beautifull
							birth city with others.
						</ProjectCard>
						<ProjectCard
							title="News App"
						...
						>
							A progressive web app that do the basic of providing you with the
							news around the world from all categorries and channels.
						</ProjectCard>
						<ProjectCard
			...
			<Content speed={0.4} offset={3}>
				<Inner>
					...
					<AboutHero>
						...
						<AboutSub>
							I'm a Full Stack Developer based in Gurugram, India. I have
							passion for intutive web and mobile design and love to create for
							web and mobile devices.
						</AboutSub>
					</AboutHero>
					<AboutDesc>
						Frontend Skills : JavaScript | React | React Native | HTML5 | CSS |
						jQuery <br />
						Backend Skills : Express | Redux | MongoDB | GraphQL
						<br />
						Technologies : REST API | PWA | Hybrid Apps
						<br />
						Tools : Visual Studio Code | GIT | Slack | Adobe Illustrator | Adobe
						Photoshop
					</AboutDesc>
				</Inner>
			</Content>
				...
				<SkillWrapper>
					...
					<IconWrapper>
						<a href="https://www.linkedin.com/in/pushpendradream/">
							<SocialIcon
								imageUrl={require("../images/social-icon/linkedin.svg")}
							/>
						</a>
						<a href="https://github.com/dreamer01">
							<SocialIcon
								imageUrl={require("../images/social-icon/github.svg")}
							/>
						</a>
						<a href="https://www.twitter.com/stud2design">
							<SocialIcon
								imageUrl={require("../images/social-icon/twitter.svg")}
							/>
						</a>
						<a href="https://dribbble.com/dreamer01">
							<SocialIcon
								imageUrl={require("../images/social-icon/dribbble.svg")}
							/>
						</a>
						<a href="https://www.instagram.com/pushpendra_dream">
							<SocialIcon
								imageUrl={require("../images/social-icon/instagram.svg")}
							/>
						</a>
					</IconWrapper>
				</SkillWrapper>
